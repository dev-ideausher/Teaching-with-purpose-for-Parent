...
import 'package:teaching_with_purpose_parent/app/utils/validation.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(
                width: 343.kw,
                height: 56.kh,
                child:PRButton(title: StringConstants.continueText,onTap: () => Get.toNamed(Routes.VERIFY)),
              ),
            ],
          ),
        ),
